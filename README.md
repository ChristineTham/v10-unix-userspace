...
| `tests/` | Golden-output fixtures and compiler bootstrap checks. |
| `rootfs/` | Build output: a V8-shaped tree (`bin`, `usr/bin`, `lib`, `usr/man`). |
| `blitterm/` | Swift Blit/5620 terminal app (Phase 5). |
