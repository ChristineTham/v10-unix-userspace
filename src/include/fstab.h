...
/*
 * PORT: 128, not V7's 32, and it is NOT the same kind of change as widening a
 ...
 *
 * The longest on the development host is 52 characters
 * (/Library/Developer/CoreSimulator/Volumes/xrOS_23O470); 128 makes the mtab
 * record exactly 256 bytes, which is the same shape DIRSIZ 14 -> 254 chose and
 * for the same reason.  src/include/PORTING.md has the account.
 *
...
#define	FSTABFMT	"%128s:%128s:%2s:%d:%d\n"
