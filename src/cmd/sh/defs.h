...
/*
 * PORT: long, not int.  round() is applied to POINTERS as well as sizes --
 * addblok() has `rndstak = (char *)round(staktop, BYTESPERWORD)` -- and on a
 * 64-bit machine an int cast throws half of one away.  Same reason as Rcheat in
 * mode.h; see the note there.
 */
#define 	round(a,b)		(((long)(((char *)(a)+b)-1))&~((long)(b)-1))
