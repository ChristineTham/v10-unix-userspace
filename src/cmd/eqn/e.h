 ...
 * char * the lexer just built -- so YYSTYPE is long on a 64-bit machine (see
 * the note in cmd/yacc/y2.c).  These two declarations have to agree with it or
 * the parser and the rest of eqn disagree about the width of every value.
 */
extern long	yyval;
extern long	yylval;
extern int	eqnreg;
