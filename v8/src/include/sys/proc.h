...
#define	p_ignsig p_siga0	/* ignored signal mask */
	int	p_flag;
	/*
	 * PORT: these four were short, and a macOS pid does not fit in one.
	 * V7 wrapped mpid at 30000 so 16 bits was the whole range; this host
	 * runs pids to 99998 -- 99698 observed live -- and a truncated pid is
	 * NEGATIVE, so ps printed -21391 for 44145.  See src/include/PORTING.md;
	 * p_uid is widened with them because the alignment padding after a
	 * 16-bit p_uid costs the same four bytes as the field does.
	 */
